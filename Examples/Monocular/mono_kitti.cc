...
int main(int argc, char **argv)
{
    ...
    std::string filnamePostfix(argc>5 ? argv[5] : "");

    // Save camera trajectory
    SLAM.SaveFrameTrajectoryJson("FrameTrajectory"+filnamePostfix+".json");

    SLAM.SaveKeyFrameAndMapPointsTrajectoryMeshReconstruction("KeyFrameAndPointsTrajectory"+filnamePostfix+".json");
